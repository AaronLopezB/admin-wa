                        ...
                        <div class="Typeahead Typeahead--twitterUsers">
                            <div class="u-posRelative">
                                <input class="demo-input Typeahead-input form-control-plaintext w-100" type="text"
                                    placeholder="Precione enter para poder realizar la busqueda" name="search" title=""
                                    autofocus>
                            ...
                            <div class="Typeahead-menu">
                                ...
                                <ul id="data-search" class="summery-contain"
                                    style="max-height: 240px; overflow-y: auto; padding-left: 15px;">
                                </ul>

                                <div class="freeze-ui4 d-none" id="preloadSearch" data-text=""></div>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0">
                    <div class="d-flex profile-media"><img class="b-r-10"
                        ...
                        <div class="flex-grow-1"><span>{{ ucfirst(auth()?->user()?->name) }}</span>
                            <p class="mb-0">{{ Str::limit(ucfirst(auth()?->user()?->email),10) }}
                                {{-- - {{ auth()?->user()?->getRoleNames()[0] }} --}} <i
                                    class="middle fa-solid fa-angle-down"></i></p>
                        </div>
                    </div>
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="{{ route('profile.edit') }}"><i data-feather="user"></i><span>Mi perfil </span></a>
                        </li>
                        {{-- <li><a href=""><i
