                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    ...
                                                                    <div style="max-width: 180px;"><img
                                                                            src="https://467afd73ab.imgdist.com/pub/bfra/ck29ikhp/v9j/7fk/gvk/wa_es_v2.webp"
                                                            ...
                                                            <td class="pad" style="width:100%;">
                                                                <div class="alignment" align="center"
                                                                    ...
                                                                    <div style="max-width: 600px;"><img
                                                                            {{-- src="{{ "https://admin.world-adventures.es/imgs/gift_mail/{$reservation['qr_image']}" }}" --}}
                                                                            src="{{ url("imgs/gifts/mail/{$reservation['qr_image']}") }}"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
