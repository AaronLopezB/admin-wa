            ...
            <div class="card checkout-cart">
                <div class="card-body basic-wizard important-validation" wire:ignore>
                    ...
                    <div class="shipping-content" id="msform">
                        <form class="stepper-one row g-3 needs-validation shipping-wizard {{ $infoCustomer === true?'d-none':'' }}" id="infoCustomerf" wire:submit.prevent="formInfoCustomer">
                                ...
                                <div class="shipping-title">
                                    <h6>Delivery Address</h6><button class="btn btn-primary" type="button"
                                        ...
                                        data-whatever="@getbootstrap"> <i
                                            class="fa-solid fa-square-plus f-20"></i></button>
                                </div>
                                            ...
                                            <div class="collect-address">
                                                <div class="d-flex gap-2 align-items-center">
                                                    <div class="form-check radio radio-primary"><input
                                                            class="form-check-input" id="shipping-choose1" type="radio"
                                                            name="radio1" value="option1" checked=""><label
                                                            class="form-check-label mb-0" for="shipping-choose1">Blakely
                                                            Roy</label>
                                                    </div>
                                                </div>
                                                <div class="card-icon"><i class="fa-solid fa-pencil"></i><i
                                    ...
                                    <div class="col-12">
                                        <div class="card-wrapper border rounded-3 h-100 light-card">
                                            <div class="collect-address">
                                                <div class="d-flex gap-2 align-items-center">
                                                    <div class="form-check radio radio-primary"><input
                                                            class="form-check-input" id="shipping-choose2" type="radio"
                                                            name="radio1" value="option1" checked=""><label
                                                            class="form-check-label mb-0" for="shipping-choose2">Lia
                                                            Dyer</label>
                                                    </div>
                                                </div>
                                                <div class="card-icon"><i class="fa-solid fa-pencil"></i><i
                            ...
                            <div class="col-xxl-7 col-md-6 box-col-6">
                                ...
                                <div class="row shipping-method g-3 mt-0 flex-column">
                                    <div class="col-12">
                                        <div class="card-wrapper border rounded-3 h-100 light-card">
                                            <div class="form-check radio radio-primary"><input class="form-check-input"
                                                    id="shipping-choose3" type="radio" name="radio2" value="option1"
                                                    checked=""><label class="form-check-label mb-0"
                                                    for="shipping-choose3">Standard Delivery -
                                                    Free</label></div>
                                    ...
                                    <div class="col-12">
                                        <div class="card-wrapper border rounded-3 h-100 light-card">
                                            <div class="form-check radio radio-primary"><input class="form-check-input"
                                                    id="shipping-choose4" type="radio" name="radio2" value="option1"
                                                    checked=""><label class="form-check-label mb-0"
                                                    for="shipping-choose4">Express Delivery -
                                                    $30</label></div>
                                    ...
                                    <div class="col-12">
                                        <div class="card-wrapper border rounded-3 h-100 light-card">
                                            <div class="form-check radio radio-primary"><input class="form-check-input"
                                                    id="shipping-choose6" type="radio" name="radio2" value="option1"
                                                    checked=""><label class="form-check-label mb-0"
                                                    for="shipping-choose6">Future Delivery</label></div>
                                ...
                                <div class="modal-body">
                                    <form class="row g-3 needs-validation" novalidate="">
                                        ...
                                        <div class="col-12"><label class="form-label" for="validationAddress-a">Current
                                                Address</label><textarea class="form-control" id="validationAddress-a"
                                        ...
                                        <div class="col-sm-6"><label class="form-label"
                                                ...
                                                id="validationCity" type="text" placeholder="Enter city" required="">
                                        ...
                                        <div class="col-12">
                                            <div class="modal-footer gap-2"><button class="btn button-light-primary m-0"
    ...
    $(document).ready(function () {
        ...
        $wire.on('processPaymentMethod', async ()=>{
            ...
            if (error) {
                ...
                // @this.set('payment_token',paymentMethod.id);
                $wire.dispatch('paymentMethodCreated',{
