                                                ...
                                                <div class="card-body dark-timeline">
                                                    <ul>
                                                        <li class="d-flex">
                                                            ...
                                                            <div class="w-100 ms-3">
                                                                <p class="d-flex justify-content-between mb-2">
                                                                    <span class="date-content light-background">12th
                                                                        Feb, 2024
                                                        ...
                                                        <li class="d-flex">
                                                            ...
                                                            <div class="w-100 ms-3">
                                                                ...
                                                                <h6>Brand Collaboration<span
                                                                    ...
                                                                    look.</span><span class="c-o-light">Multimedia
                                                        ...
                                                        <li class="d-flex">
                                                            ...
                                                            <div class="w-100 ms-3">
                                                                <p class="d-flex justify-content-between mb-2">
                                                                    <span class="date-content light-background">08th
                                                                        Feb, 2024 </span><span>5 days
                                                                        ago</span></p>
                                                                <h6>Review of Project and
                                                                    Milestones<span class="dot-notification"></span>
                                                                    ...
                                                                    "Multikart and
                                                                    Fastkart."</span><span class="c-o-light">This
                                                                    entails being
                                                        ...
                                                        <li class="d-flex">
                                                            ...
                                                            <div class="w-100 ms-3">
                                                                <p class="d-flex justify-content-between mb-2">
                                                                    <span class="date-content light-background">05th
                                                            ...
                                                            <div class="list-box title-line-primary">
                                                                <div class="header-top"><span
                                                                    ...
                                                                    <p class="mb-0 c-o-light"> <svg class="me-2">
                                                                            <use
                                                                                href="../assets/svg/icon-sprite.svg#vector-calendar">
                                                                            </use>
                                                                        </svg>06 Nov, 2024</p>
                                                                </div>
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid"
                                                                            src="../assets/images/project/list/1.png"
                                                                            alt="dashboard">
                                                                        <div>
                                                                            <h6>CRM Dashboard</h6>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-success">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid"
                                                                            src="../assets/images/project/list/2.png"
                                                                            alt="application">
                                                                        <div>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-primary">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid"
                                                                            src="../assets/images/project/list/8.png"
                                                                            alt="e-commerce web">
                                                                        <div>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-success">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid"
                                                                            src="../assets/images/project/list/11.png"
                                                                            alt="application">
                                                                        <div>
                                                                            <h6>Nursery App</h6>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-warning">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid"
                                                                            src="../assets/images/project/list/12.png"
                                                                            alt="landing page">
                                                                        <div>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-success">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid"
                                                                            src="../assets/images/project/list/10.png"
                                                                            alt="application">
                                                                        <div>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-warning">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid"
                                                                            src="../assets/images/project/list/9.png"
                                                                            alt="landing page">
                                                                        <div>
                                                                            <h6>NFT Website</h6>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-success">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid"
                                                                            src="../assets/images/project/list/7.png"
                                                                            alt="application">
                                                                        <div>
                                                                            <h6>Grocery App</h6>
                                                    ...
                                                    <div class="col-xxl-4 col-md-6 box-col-6 xl-50">
                                                        <div class="progress-project-box">
                                                            <div class="list-box title-line-primary">
                                                                ...
                                                                <div class="project-body">
                                                                    <div class="common-f-start"><img class="img-fluid"
                                                                            src="../assets/images/project/list/6.png"
                                                                            alt="project">
                                                                        <div>
                                                                            <h6>Sales Project</h6>
                                                                            <span>Create a chat
                                            ...
                                            <div class="card-body">
                                                <div class="user-notifications">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <div> <img class="img-fluid"
                                                                    src="../assets/images/dashboard-11/user/5.jpg"
                                                                    alt="user">
                                                                <div>
                                                                    <p>Customer input received<span class="ps-2">10h
                                                                            ago</span>
                                                            ...
                                                            <div> <img class="img-fluid"
                                                                ...
                                                                <div>
                                                                    <p>Meeting for the final client
                                                                        review<span class="ps-2">Yesterday</span>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <div> <img class="img-fluid"
                                                                    src="../assets/images/dashboard-11/user/7.jpg"
                                                                    alt="user">
                                                                <div>
                                    ...
                                    <div class="tab-pane fade show active" id="attachment" role="tabpanel"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body setting-wrapper">
                                                <form wire:submit.prevent="updateProfile" class="row g-3 needs-validation" id="formCustomer">
                                                    <input type="hidden" wire:model="reservation_id">
                                                    <div class="col-md-6 mb-2">
                                                        <label class="form-label" for="validationDefault04">Nombre</label>
                                                        <input class="form-control @error('name') is-invalid @enderror" type="text" placeholder="{{ auth()->user()->name }}" wire:model="name" required>
                                                        @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label" for="exampleFormControlTextarea1">Correo</label>
                                                        <input class="form-control @error('email') is-invalid @enderror" type="text" placeholder="{{ auth()->user()->email }}" wire:model="email" required>
                                                ...
                                                <div class="row g-md-3 g-2">
                                                    <div class="col-md-3"><label class="form-label mb-0">Select
                                                            Language</label></div>
                                                ...
                                                <div class="row g-md-3 g-2">
                                                    <div class="col-md-3"><label class="form-label mb-0">Recent Activity
                                                        </label></div>
                                                    <div class="col-md-9">
                                                        <div class="form-check form-switch form-check-inline">
                                                            <input class="form-check-input switch-primary check-size"
                                                ...
                                                <div class="row g-md-3 g-2">
                                                    <div class="col-md-3"><label class="form-label mb-0">Two-factor
                                                ...
                                                <div class="row g-md-3 g-2">
                                                    <div class="col-md-3"><label class="form-label mb-0">Post
                                                ...
                                                <div class="row g-md-3 g-2">
                                                    <div class="col-md-3"><label class="form-label mb-0">Remove
                                                            Accounts</label></div>
                                                    <div class="col-md-9">
                                                        <div class="form-check form-switch form-check-inline">
                                                            <input class="form-check-input switch-primary check-size"
                                                        ...
                                                        <div class="common-flex mt-3"><a
                                                                class="btn button-light-danger disabled" href="#!"
                                                                role="button">Disable
                                                                Account</a><a class="btn btn-danger" href="#!"
                                                                role="button">Delete
                                                                Account</a></div>
                                                    </div>
                                                </div>--}}
