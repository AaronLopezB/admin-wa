                        ...
                        <div class="col-xxl-3 col-xl-4 box-col-4e sidebar-left-wrapper">
                            <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" id="gallery-product-tab" data-bs-toggle="pill"
                                        ...
                                        <div class="nav-rounded">
                                            <div class="product-icons"><svg class="stroke-icon">
                                                    <use href="../assets/svg/icon-sprite.svg#product-gallery">
                                                    </use>
                                                </svg></div>
                                        </div>
                                        <div class="product-tab-content">
                                ...
                                <li class="nav-item"><a class="nav-link" id="advance-product-tab" data-bs-toggle="pill"
                                        ...
                                        <div class="nav-rounded">
                                            <div class="product-icons"><svg class="stroke-icon">
                                                    <use href="../assets/svg/icon-sprite.svg#advance">
                                                    </use>
                                                </svg></div>
                                        </div>
                                        <div class="product-tab-content">
                                    ...
                                    <div class="sidebar-body">
                                        <form class="row g-3 common-form">
                                            <div class="col-12"><label class="form-label"
                                                ...
                                                </label><input class="form-control" id="exampleFormControlInput1" value="{{ $vehicle->nombre }}"
                                                    type="text" placeholder="Enter a number"></div>
                                            <div class="col-md-12"><label class="form-label"
                                                    for="validationProductTitle">Product
                                                    Title</label><input class="form-control" id="validationProductTitle"
                                            ...
                                            <div class="col-12 product-buttons"><button class="btn m-0" type="button"
                                                    >Next<svg>
                                                        <use href="../assets/svg/icon-sprite.svg#front-arrow">
                                                        </use>
                                                    </svg></button></div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="sidebar-body common-form">
                                        ...
                                        <div class="product-buttons"><button class="btn" type="button"
                                                onclick="handleNextButtonClick('detail-product-tab')"><svg>
                                                    <use href="../assets/svg/icon-sprite.svg#back-arrow">
                                                    </use>
                                ...
                                <div class="tab-pane fade" id="category-product" role="tabpanel"
                                    ...
                                    <div class="sidebar-body common-form e-category">
                                                            ...
                                                            <div class="p-20">
                                                                <form class="row g-3 needs-validation" novalidate="">
                                                                    <div class="col-md-6"><label class="form-label"
                                                                            ...
                                                                            class="form-control" id="validationCategory"
                                                                            type="text"
                                                                    ...
                                                                    <div class="col-lg-6"><label class="form-label"
                                                                            ...
                                                                            class="form-control" id="validationKeywords"
                                                                            type="text"
                                        ...
                                        <form class="row g-3 common-form">
                                            ...
                                            <div class="col-auto">
                                                <div class="category-btn"><a class="btn button-primary" href="#!"
                                                        data-bs-toggle="modal" data-bs-target="#category-pill-modal"><i
                                                            class="me-2 fa-solid fa-plus"> </i>Create
                                                        New Category</a></div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="pricings" role="tabpanel" aria-labelledby="pricings-tab">
                                    <form class="price-wrapper common-form row g-3">
                                        <div class="col-sm-6"> <label class="form-label" for="initialCost">Initial
                                                Price</label><input class="form-control" id="initialCost" type="number"
                                        ...
                                        <div class="col-12"><label class="form-label">Product Discount
                                            ...
                                            <ul class="nav nav-pills discount-options" id="product-discount-pills-tab"
                                                ...
                                                <li class="nav-item"> <a class="nav-link" id="bogo-offer-tab"
                                                        ...
                                                        aria-controls="bogo-offer" aria-selected="false"><span>BOGO (Buy
                                                            One, Get
                                                            One)</span></a></li>
                                                ...
                                                <li class="nav-item"><a class="nav-link" id="bulk-discount-tab"
                                                        ...
                                                        aria-controls="bulk-discount" aria-selected="false"><span>Volume
                                                            or Bulk
                                                            Discount</span></a></li>
                                            </ul>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="row g-3">
                                                                    ...
                                                                    <div class="col-sm-6"><label class="form-label"
                                                                            ...
                                                                            placeholder="Discount" required=""></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="meta-body">
                                                    <form class="common-form row g-3" id="advance-tab">
                                                        ...
                                                        <div class="col-xxl-4 col-sm-6"><label class="form-label"
                                                                ...
                                                                Quantity <span class="txt-danger">*</span></label><input
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-check"><input class="form-check-input"
                                                                    ...
                                                                    class="form-check-label m-0" for="gridCheck">This is
                                                                    a digital
                                                                    product.</label></div>
                                                        </div>
                                                        <div class="col-12 product-buttons"><button class="btn"
                                                                ...
                                                                onclick="handleNextButtonClick('pricings-tab')"><svg>
                                                                    <use
                                                                        href="../assets/svg/icon-sprite.svg#back-arrow">
                                                                    </use>
                                                                </svg>Previous</button><button class="btn" type="button"
                                                                onclick="handleNextButtonClick('seo-option-tab')">Next<svg>
                                                                    <use
                                                                        href="../assets/svg/icon-sprite.svg#front-arrow">
                                                                    </use>
                                                                </svg></button></div>
                                                    </form>
                                                </div>
                                                ...
                                                <div class="meta-body">
                                                    <form class="row g-3 common-form">
                                                        ...
                                                        <div class="col-xxl-6"><label class="form-label"
                                                                ...
                                                                id="validationCustom-9" type="text"
                                                                placeholder="Enter meta keywords"></div>
